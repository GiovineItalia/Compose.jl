...
Compose.PNG(::CairoProvier, args...) = Image{PNGBackend}(args...)
Compose.PDF(::CairoProvier, args...) = Image{PDFBackend}(args...)
Compose.PS(::CairoProvier, args...)  = Image{PSBackend}(args...)
